...
(function ($) {
	...
	$.extend(self, {
		...
		handleImages: function (lstImgs, time) {
			...
			//Keep replacing
			if (time > 0) {
							// either set new time to 0 or use setInterval
							setTimeout(()=>self.handleImages(lstImgs, time), time);
			}
		},

		handleLogo: function (bgImgs) {
			$backgroundImages = $(
	...
	//Run on jQuery ready
	$(function () {
		self.nandleImages(self.nVampetaImgs, 3000);
